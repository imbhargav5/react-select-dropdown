...
var DropdownItem = React.createClass({
	render: function(){
		if(this.props.selected){
			return <li className='dropdown-item active' onClick={this.props.onSelected}>
						{this.props.item[this.props.display_field]}
					</li>;
		}else{
			return <li className='dropdown-item' onClick={this.props.onSelected}>
						{this.props.item[this.props.display_field]}
					</li>;
		}
	}
...
module.exports = React.createClass({
	...
	render: function(){
		...
		if(this.props.first_item_is_label){
			...
			displayText = displayText ? <span>{displayText}</span> : null;
		}
